...
class DirectAPISearchService: ObservableObject {
    ...
    // MARK: - Logger
    private let logger = Logger(subsystem: "AppleTVBrowser", category: "DirectAPISearchService")
    ...
    enum SearchError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .apiKeyMissing:
                return "API-Key nicht konfiguriert - siehe DirectAPISearchService.swift"
            case .apiQuotaExceeded:
