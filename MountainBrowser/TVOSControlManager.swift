...
/// FIX: Entfernt die problematische NotificationCenter-Subscription,
/// die den Apple TV im Ruhezustand aufwecken konnte.
struct TVOSRemoteOptimized: ViewModifier {
    func body(content: Content) -> some View {
        content
        // FIX: ENTFERNT — Die Subscription auf UITextInputMode.currentInputModeDidChangeNotification
        // konnte den Apple TV im Ruhezustand aufwecken, da das System diese Notification
        // auch im Hintergrund senden kann. Die Subscription war ohnehin ein No-Op.
    }
}
